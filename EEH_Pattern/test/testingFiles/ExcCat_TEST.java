...
public class ExcCat_TEST{
	 ...
	 * 
	 * @return CatalogedException for named exception <B>FILE_NOT_FOUND_EXCEPTION</B>
	 * 
	 ...
	 */
	public static CatalogedException excFILE_NOT_FOUND_EXCEPTION(
		...
		return new CatalogedException(ExceptionHandler.PRI_INFO,
						"FILE_NOT_FOUND_EXCEPTION",hashParm,name,version);
	}
	 ...
	 * @param strTODO	Description of the exception
	 * 
	 * @return CatalogedException for named exception <B>BUG_IO_EXCEPTION</B>
	 * 
	 * @exception CatalogedException of the following flavours:<BR>
	 *                - EXC_CAT.CATALOG_UNDEF<BR>
	 *                - EXC_CAT.EXCEPTION_UNDEF<BR>
	 ...
	 *                - EXC_CAT.PARM_INVALID_INTERNAL<BR>
	 */
	public static CatalogedException excBUG_IO_EXCEPTION(
											String strTODO) throws CatalogedException {
		...
		return new CatalogedException(ExceptionHandler.PRI_INFO,
						"BUG_IO_EXCEPTION",hashParm,name,version);
	}
	...
	public static ExcCatInfo getExcCatInfo() {
		...
		// EXC_FILE_NOT_FOUND_EXCEPTION
		ei = new ExcInfo();
		ei.strExc = "FILE_NOT_FOUND_EXCEPTION";
		ei.nPriority = 1;
		ei.nCode = 90001;
		ei.strDescr = "";
		...
		// EXC_BUG_IO_EXCEPTION
		ei = new ExcInfo();
		ei.strExc = "BUG_IO_EXCEPTION";
		ei.nPriority = 1;
		ei.nCode = 90002;
		ei.strDescr = "";
		ei.addParameter("TODO","Description of the exception");
